...
Source0  : https://github.com/krb5/krb5/archive/krb5-1.20.1-final/krb5-1.20.1.tar.gz
...
%prep
%setup -q -n krb5-krb5-1.20.1-final
cd %{_builddir}/krb5-krb5-1.20.1-final
%patch1 -p1
pushd ..
cp -a krb5-krb5-1.20.1-final build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668559429

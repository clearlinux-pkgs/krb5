...
%prep
%setup -q -n krb5-krb5-1.19.3-final
cd %{_builddir}/krb5-krb5-1.19.3-final
%patch1 -p1
pushd ..
cp -a krb5-krb5-1.19.3-final build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647385502
...
cp %{_builddir}/krb5-krb5-1.19.3-final/src/lib/gssapi/LICENSE %{buildroot}/usr/share/package-licenses/krb5/feb23c7f425c7c619cb04c91997f471e2d3b8e9b
pushd ../build32/src
%make_install32
